...
extension UIImageView {
    ...
    public func loadImage(fromUrl strUrl: String, identifier: String) {
        ...
        DispatchQueue.global().async {
            // Search if image was previously saved
            ...
            // Fetches the image on the internet
            ...
            if let dirPath = paths.first {
                let url = URL(fileURLWithPath: dirPath).appendingPathComponent(identifier)
